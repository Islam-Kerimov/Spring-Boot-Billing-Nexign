...
import static ru.nexign.spring.boot.billing.model.entity.Role.MANAGER;
import static ru.nexign.spring.boot.billing.model.entity.Role.SUBSCRIBER;

/**
 * Настройка сервиса авторизации и аутентификации.
 */
@Configuration
@EnableWebSecurity
...
public class SecurityConfiguration {
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		http
			...
			.requestMatchers("/api/v1/manager/**").hasAuthority(MANAGER.name())
			.requestMatchers("/api/v1/abonent/**").hasAuthority(SUBSCRIBER.name())
